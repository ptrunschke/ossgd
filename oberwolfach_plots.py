...
plots = [
    dict(input_name = "data/sgd_legendre10_t10_optimal1_Sinf_sconstant_i10000_quasi.npz"
         output_name = "plots/optimal_recovery.png"
         trendline = False
         teaser = False),
    dict(input_name = "data/sgd_legendre10_t10_uniform1_Sinf_sconstant_i10000_quasi.npz"
         output_name = "plots/uniform_recovery.png"
         trendline = False
         teaser = False),
    dict(input_name = "data/sgd_legendre10_t15_optimal1_Sinf_sdeterministic_unbounded_i10000_quasi.npz"
         output_name = "plots/optimal_nonrecovery.png"
         trendline = True
         teaser = False),
    dict(input_name = "data/sgd_legendre10_t15_uniform1_Sinf_sdeterministic_unbounded_i10000_quasi.npz"
         output_name = "plots/uniform_nonrecovery.png"
         trendline = True
         teaser = False),
    dict(input_name = "data/sgd_legendre10_t15_optimal50_Sinf_sadaptive_i10000_quasi.npz"
...
def plot_data(input_name, output_name, trendline, teaser):
